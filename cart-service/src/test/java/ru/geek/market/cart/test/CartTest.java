...
public class CartTest {
    ...
    private ProductDto productDto1 = new ProductDto(1L, "Potato", 1.2, "Other vegetables");
    private ProductDto productDto2 = new ProductDto(3L, "Onion", 1.1, "Other vegetables");
    private CartItem item1 = new CartItem(1L, "Potato", 1.2, 1, 1.2);
    private CartItem item2 = new CartItem(2L, "Cabbage", 1.5, 1, 1.5);
    ...
    private void fillTestCartWithItems() {
        cartToTest = new Cart(cartItems, 2.7);
    }
    ...
    void addProductToCartTest() {
        ...
        Assertions.assertEquals(1.2, updatedItem.getProductPrice());
        Assertions.assertEquals(2.4, updatedItem.getPriceCalculated());
    }
    ...
    void calculateTotalPriceTest() {
        ...
        cartToTest.addProductToCart(productDto1);
        Assertions.assertEquals(2.4, cartToTest.getTotalPrice());

        cartToTest.addProductToCart(productDto2); // price +1.1
        Assertions.assertEquals(3.5, cartToTest.getTotalPrice());
    }
    ...
    void removeProductTest(){
        ...
        Assertions.assertEquals(1, cartToTest.getItems().size());
        Assertions.assertEquals(1.5, cartToTest.getTotalPrice());
