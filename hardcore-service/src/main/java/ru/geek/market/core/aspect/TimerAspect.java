package ru.geek.market.core.aspect;
...
public class TimerAspect {
    ...
    @Pointcut("@within(ru.geek.market.core.annotation.LogExecutionTime)")
    public void pointcutForAnnotatedClasses(){}

    @Pointcut("@annotation(ru.geek.market.core.annotation.LogExecutionTime)")
